...
<html lang="en">
    ...
    <body>
        ...
        <section class="container mt-5 w-50 w-sm-100">
            ...
            <p class="lead text-center">Fill out the following information to start tracking your percentage.</p>

            <div class="bg-light border border-black rounded-3 px-3 py-2 w-100 mx-auto">
                <form action="?command=newPctStatistic" method="post">
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="text" class="form-control w-75 w-sm-100" id="pctDescription" name="pctDescription" placeholder="e.g. attempted free throws made">
                        </div>
                    </div>
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="number" class="form-control w-auto" id="pctNumeratorValue" name="pctNumeratorValue" placeholder="e.g. 10">
                        </div>
                    </div>
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="number" class="form-control w-auto" id="pctDenominatorValue" name="pctDenominatorValue" placeholder="e.g. 20">
                        </div>
                    </div>
                    <div class="form-group row py-3">
