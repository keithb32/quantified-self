...
<html lang="en">
    ...
    <body>
        ...
        <section class="container mt-5 w-50 w-sm-100">
            ...
            <p class="lead text-center">Fill out the following information to edit your count statistic.</p>

            <div class="bg-light border border-black rounded-3 px-3 py-2 w-100 mx-auto">
                <form action="?command=newCountStatistic" method="post">
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="text" class="form-control w-75 w-sm-100" id="countDescription" name="countDescription" placeholder="e.g. books read">
                        </div>
                    </div>
                    <div class="form-group row py-3">
                        <label for="countValue" class="col-sm-3 col-form-label fw-bold">Value <br> (required)</label>
                        <div class="col-sm-9">
                            <p>Enter the quantity for your statistic.</p>
                            <input required type="number" class="form-control w-auto" id="countValue" name="countValue" placeholder="e.g. 10">
                        </div>
                    </div>
                    <div class="form-group row py-3">
