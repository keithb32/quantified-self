...
<html lang="en">
    <head>
        ...
        <script src="../../../scripts/count_statistic.js"></script>
    </head>  
    ...
    <body>
        ...
        <section class="container mt-5 w-50 w-sm-100">
            <h2 class="text-center my-3">Count Statistic</h2>
            <p class="lead text-center">Fill out the following information to edit your count.</p>

            <div class="bg-light border border-black rounded-3 px-3 py-2 w-100 mx-auto">
                <form action="?command=updateCountStatistic&statId=<?= $statId ?>" method="post">
                    <div class="form-group row py-3">
                        <label for="countDescription" class="col-sm-3 col-form-label fw-bold">Description <br> (required)</label>
                        <div class="col-sm-9">
                            <p>Fill in the blank: Number of 
                                <span id="countDescriptionPlaceholder" class="text-decoration-underline">____</span>
                            </p>
                            <input required type="text" class="form-control" id="countDescription" name="countDescription" placeholder="e.g. books read" value="<?= $description ?>">
                        </div>
                    </div>
                    <div class="form-group row py-3">
                        <label for="countValue" class="col-sm-3 col-form-label fw-bold">Value <br> (required)</label>
                        <div class="col-sm-9">
                            <input required type="number" class="form-control w-auto" id="countValue" name="countValue" placeholder="e.g. 10" value="<?= $value ?>">
                        </div>
                    </div>
                    <div class="form-group row py-3">
                        <label for="tags" class="col-sm-3 col-form-label fw-bold">Tags</label>
                        <div class="col-sm-9">
                            <p>Enter a series of space-separated keywords to help search for your statistic efficiently.</p>
                            <input type="text" class="form-control" id="tags" name="tags" placeholder="e.g. basketball sports games" value="<?= $tags ?>">
                        </div>
                    </div>
                    <div class="form-group row py-3">
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-outline-primary px-4 mx-2">Save changes</button>
                    </div>
                </form>
            </div>
            <form action="?command=deleteCountStatistic&statId=<?= $statId ?>" method="post">
