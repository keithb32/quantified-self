...
<html lang="en">
    ...
    <body>
        ...
        <section class="container mt-5 w-50 w-sm-100">
            ...
            <p class="lead text-center">Fill out the following information to edit your rate statistic.</p>

            <div class="bg-light border border-black rounded-3 px-3 py-2 w-100 mx-auto">
                <form action="?command=updateRateStatistic&statId=<?= $statId ?>" method="post">
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="text" class="form-control w-auto d-inline" id="rateDescription1" name="rateDescription1" placeholder="e.g. points" value=<?= $description1 ?>>
                            <p class="d-inline mx-2">per</p>
                            <input required type="text" class="form-control w-auto d-inline" id="rateDescription2" name="rateDescription2" placeholder="e.g. game" value=<?= $description2 ?>>
                        </div>
                    </div>
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="number" class="form-control w-auto" id="rateNumeratorValue" name="rateNumeratorValue" 
                    ...
                    <div class="form-group row py-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="number" class="form-control w-auto" id="rateDenominatorValue" name="rateDenominatorValue" 
            ...
            <form action="?command=deleteRateStatistic&statId=<?= $statId ?>" method="post">
